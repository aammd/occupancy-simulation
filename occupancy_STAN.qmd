...
- [X] Illustrate the model like in https://mc-stan.org/bayesplot/articles/plotting-mcmc-draws.html
...
- [ ] Simulate and run a model with all the relevent parameter varying with year
