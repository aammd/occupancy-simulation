...
# Remove b1 in .join
fake_data_b1[7][[1]] <- fake_data_b1[7][[1]][-4]
```
...
sampl_b1_fixed_stan$draws(variables = c("prob_detect", "log_a1", "log_a2", "b1", "b1")) |> 
...
draws <- sampl_b1_fixed_stan$draws(variables = c("prob_detect", "log_a1", "log_a2", "b1", "b1"))
